...
class TheShortestPath {
	...
	/**
	 * Find the shortest path from station x to station y through stations u and v
	 *
	 * @param a
	 * @param b
	 * @param c
	 * @return returns the route to take to get the shortest path between stations
	 */
	 ...
	 * @param b
	 * @param c
	 * @return returns the shortest distance between the stations
	 */
